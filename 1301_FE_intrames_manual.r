#!/usr/bin/env Rscript
cat( "ETAPA  1301_FE_intrames_manual.r  INIT\n")
...
AgregarVariables_IntraMes <- function(dataset) {
  ...
  dataset[, pesos := fifelse(foto_mes %in% c(202106,202006,201906), 0.95^0,
                             fifelse(foto_mes %in% c(202105, 202005, 201905), 0.95^1,
                                     fifelse(foto_mes %in% c(202104, 202004, 201904), 0.95^2,
                                             fifelse(foto_mes %in% c(202103, 202003, 201903), 0.95^3,
                                                     fifelse(foto_mes %in% c(202102, 202002, 201902), 0.95^4,
                                                             fifelse(foto_mes %in% c(202101, 202001, 201901), 0.95^5, NA))))))]
...
cat( "ETAPA  1301_FE_intrames_manual.r  END\n")
